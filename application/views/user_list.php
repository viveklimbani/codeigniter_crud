				...
				<tbody>
					...
					foreach($users as $user){
						...
						<tr>
							...
							<a href="<?php echo base_url(); ?>index.php/users/delete/<?php echo $user->id; ?>" onclick="return confirm('Are u Want to sure delete this items')" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
						</tr>
						<?php
					}
					?>
